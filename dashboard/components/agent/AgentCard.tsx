      ...
      <Card className="cursor-pointer group relative overflow-hidden">
        ...
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <div className="flex items-center gap-3">
            <div className="relative h-10 w-10 rounded-lg bg-primary/5 border border-primary/20 flex items-center justify-center group-hover:border-primary/40 transition-all duration-300">
              <Shield className="h-5 w-5 text-primary" />
              <div className="absolute inset-0 blur-md bg-primary/0 group-hover:bg-primary/10 rounded-lg transition-all duration-300" />
            </div>
            <div>
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4 mt-2 pt-3 border-t border-border/50">
            ...
            <div>
              <div className="flex items-center gap-1.5 mb-1">
                <Shield className="h-3 w-3 text-amber-400/70" />
